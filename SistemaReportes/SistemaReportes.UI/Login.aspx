<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="SistemaReportes.UI.Login" %>
...
<body>
   ...
   <asp:Label ID="lbCategoria" runat="server" Text="Categoria: "></asp:Label>
        <asp:DropDownList ID="ddlCategorias" runat="server" CssClass="form-control" Width="280"></asp:DropDownList>
         ...
         <br />
        <asp:Button ID="btnInsertar" runat="server" Text="Insertar" CssClass="btn btn-primary" OnClick="btnInsertar_OnClick" />
